import {
  ...
  const experiences = [
    ...
    },
    {
      ...
      points: [
        "Data Analysis for Sales Managers.",
        "Quota Management in SAP.",
        "Demand Forecast Division at District Level.",
        "Support for DSMs to Manage Control Towers.",
        "Dashboard Update in Power BI.",
        "Process Automation and Programming in VBA.",
        "Data Manipulation via PowerQuery.",
        "Dremio Database Management for Information Control.",
      ],
    },
  ];
